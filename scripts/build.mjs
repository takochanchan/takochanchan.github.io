...
const assetVersion = "20260828-bonaparte-nicaragua-canal";
...
const catalogueOriginalTitleMarkup = (item, className) =>
  `<p class="${className}"><span>原題</span><cite>${escapeHtml(item.originalTitle)}</cite></p>`;
    ...
    <div class="site-search__inner">
      ...
      <div class="fulltext-search-block">
        ...
        <p class="fulltext-help" id="fulltext-scope">
          ...
          底本位置標識（原刊頁・写本葉丁・画像番号など）と日本語版PDFの物理頁を併記します。大冊は最初の一致頁を先に表示し、
          全一致頁を資料ごとに展開できます。
        </p>
      </div>
