...
request=json.loads(pathlib.Path('.publication-upload-requests/palacio-carta-rey-espana-1860.json').read_text())
assert request['slug']=='palacio-carta-rey-espana-1860'
