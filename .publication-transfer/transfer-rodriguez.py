...
request=json.loads(pathlib.Path('.publication-upload-requests/rodriguez-relacion-espantable-terremoto-1541.json').read_text())
assert request['slug']=='rodriguez-relacion-espantable-terremoto-1541'
