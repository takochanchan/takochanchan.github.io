...
request=json.loads(pathlib.Path('.publication-upload-requests/how-james-b-eads-1900.json').read_text())
assert request['slug']=='how-james-b-eads-1900'
...
with tempfile.TemporaryDirectory() as temp:
    ...
    subprocess.run(['gh','release','upload','publications-current',*paths,'--repo',repo,'--clobber'],check=True)
