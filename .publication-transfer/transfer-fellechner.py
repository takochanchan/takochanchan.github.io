...
request=json.loads(pathlib.Path('.publication-upload-requests/fellechner-mueller-hesse-mosquitoland-1845.json').read_text())
assert request['slug']=='fellechner-mueller-hesse-mosquitoland-1845'
