...
request=json.loads(pathlib.Path('.publication-upload-requests/foreign-office-mosquito-territory-1848.json').read_text())
assert request['slug']=='foreign-office-mosquito-territory-1848'
